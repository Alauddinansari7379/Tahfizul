...
public class TalibHomeActivity extends AppCompatActivity {
    ...
    private static final String TAG = "TalibHomeActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_talib_home);
    ...
    private void initRecycler()
    {
        ...
        adapter = new MaulemSlotsAdapter(this, slotList);
    ...
    private void setListener()
    {
        testCallBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                checkPermissions("2021-12-16", "03:25:00", "03:30:00", "9", talibID);
            }
        });
    ...
    private void fetchClassSlots()
    {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, talibClassSlotsUrl+talibID, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if(status)
                    {
                        ...
                        {
                            //no record found
                            Toast.makeText(TalibHomeActivity.this, "No Record Found!", Toast.LENGTH_SHORT).show();
                        }
                    }
                    else
                    {
                        //no record found
                        Toast.makeText(TalibHomeActivity.this, "No Classes Found!", Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(TalibHomeActivity.this, R.string.common_error, Toast.LENGTH_SHORT).show();
        ...
        RequestQueue queue = Volley.newRequestQueue(TalibHomeActivity.this);
        queue.add(request);
    }
    ...
    {
        Dexter.withActivity(TalibHomeActivity.this)
    ...
    private void callAction(String strDate, String startTime, String endTime, String maulimId, String talibId)
    {
        if(new MyTimeCalculator().inTimeFrame(strDate, startTime, endTime))//check appointment date n time with current date n time
        {
            ...
            if(secLeft > 0)
            {
                Intent intent = new Intent(TalibHomeActivity.this, JitsiCallActivity.class);
            ...
            {
                Toast.makeText(TalibHomeActivity.this, "Your session is over!", Toast.LENGTH_SHORT).show();
            }
        }
        else
        {
            ...
            if(secLeft > 0)
            {
                Toast.makeText(TalibHomeActivity.this, "Its not Class time!", Toast.LENGTH_SHORT).show();
            }
            else
            {
                Toast.makeText(TalibHomeActivity.this, "Your Class is over!", Toast.LENGTH_SHORT).show();
            }
        }
